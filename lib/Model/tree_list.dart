class TreeListModel {
  ...
  TreeListModel({TreeData data, int errorCode, String errorMsg}) {
    this._data = data;
  ...
  set data(TreeData data) => _data = data;
  int get errorCode => _errorCode;
  set errorCode(int errorCode) => _errorCode = errorCode;
  String get errorMsg => _errorMsg;
  set errorMsg(String errorMsg) => _errorMsg = errorMsg;

  TreeListModel.fromJson(Map<String, dynamic> json) {
    _data = json['data'] != null ? new TreeData.fromJson(json['data']) : null;
...
class TreeData {
  ...
  List<TreeListItem> get datas => _datas;
  set datas(List<TreeListItem> datas) => _datas = datas;
  ...
  TreeData.fromJson(Map<String, dynamic> json) {
    ...
    if (json['datas'] != null) {
      _datas = new List<TreeListItem>();
      json['datas'].forEach((v) {
        _datas.add(new TreeListItem.fromJson(v));
      });
    }
    _offset = json['offset'];
    _over = json['over'];
...
class TreeListItem {
  ...
  TreeListItem.fromJson(Map<String, dynamic> json) {
